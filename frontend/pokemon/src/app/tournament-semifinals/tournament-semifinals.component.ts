...
declare var $: any;
@Component({
  selector: 'app-tournament-semifinals',
  templateUrl: './tournament-semifinals.component.html',
  styleUrls: ['./tournament-semifinals.component.css']
})
export class TournamentSemifinalsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.num_of_match_finished = Number(localStorage.getItem("t" + this.id + "s-matches_finished"));
  ...
  find_tournament_by_id(id: Number): void {
    this.service.find_tournament_by_id(id).subscribe(data => {
      ...
      this.service.find_matches_by_type(id, "s").subscribe(data => {
            ...
            this.service.find_pokemon_by_id(m.idPokemon1).subscribe(data => {
              ...
              this.service.find_pokemon_by_id(m.idPokemon2).subscribe(data => {
                ...
                if (index == 0) {
                  ...
                  $('#progress_bar_match2_pok1').width(md.hp_left1 + "%").attr('aria-valuenow', this.num_of_match_finished);
                  $('#progress_bar_match2_pok2').width(md.hp_left2 + "%").attr('aria-valuenow', this.num_of_match_finished);
                }
                ...
                else if (index == 1 && m.result != 3) {
                  if (md.hp_left1 >= md.hp_left2) {
                    $('#progress_bar_match2_pok1').css("background-color", "green");
                    $('#progress_bar_match2_pok2').css("background-color", "red");
                  } else {
                    $('#progress_bar_match2_pok2').css("background-color", "green");
                    $('#progress_bar_match2_pok1').css("background-color", "red");
                  }
  ...
  next_stage(): void {
    ...
    this.service.get_match_max_id().subscribe(data => {
      ...
      let pok1winner: Number;
      let pok2winner: Number;
      let pok1loser: Number;
      let pok2loser: Number;
      if (this.matches[0].result == 1) {
        pok1winner = this.matches[0].idPokemon1;
        pok1loser = this.matches[0].idPokemon2;
      }
      else {
        pok1winner = this.matches[0].idPokemon2;
        pok1loser = this.matches[0].idPokemon1;
      }

      if (this.matches[1].result == 1) {
        pok2winner = this.matches[1].idPokemon1;
        pok2loser = this.matches[1].idPokemon2;
      }
      else {
        pok2winner = this.matches[1].idPokemon2;
        pok2loser = this.matches[1].idPokemon1;
      }

      this.service.add_new_match(match_max_id, 0, this.id, pok1loser, pok2loser, 't').subscribe(data => {
        match_max_id++;
        this.service.add_new_match(match_max_id, 0, this.id, pok1winner, pok2winner, 'f').subscribe(data => {
          this.router1.navigate(['/third_place/' + this.id]);
        })
      })
    })
    ...
    if (this.hp_left1 > 0 && this.hp_left2 > 0) {
      ...
      if (this.hp_left1 > 0) {
        if (i == 0) {
          ...
          $('#progress_bar_match2_pok1').width(Math.round((100 * this.hp_left1 / this.hp_pok1)) + "%").attr('aria-valuenow', this.num_of_match_finished);
        }
        ...
        if (i == 0) {
          ...
          $('#progress_bar_match2_pok1').width(0 + "%").attr('aria-valuenow', this.num_of_match_finished);
        }
      ...
      if (this.hp_left2 > 0) {
        if (i == 0) {
          ...
          $('#progress_bar_match2_pok2').width(Math.round((100 * this.hp_left2 / this.hp_pok2)) + "%").attr('aria-valuenow', this.num_of_match_finished);
        }
        ...
        if (i == 0) {
          ...
          $('#progress_bar_match2_pok2').width(0 + "%").attr('aria-valuenow', this.num_of_match_finished);
        }
      ...
      this.service.update_match(this.match.id, Math.round(this.hp_left1), Math.round(this.hp_left2), res, this.fast_attack1.id, this.fast_attack2.id, this.main_attack1.id, this.main_attack2.id).subscribe(data => {
        ...
        localStorage.setItem("t" + this.id + "s-matches_finished", String(this.num_of_match_finished));
